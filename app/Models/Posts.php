...
class Posts extends Model {
    ...
    public static function get($post_status=null, $post_author = '', $post_category=null, $keyword = '',$order = 'post_created_at',$type='desc')
    {
        if ($order==null)
    ...
    public static function increase_count($post_id)
    {
        $view = \DB::table('posts')->where('post_id','=',$post_id)->value('post_view');
        \DB::table('posts')->where('post_id','=',$post_id)->update(['post_view'=>($view+1)]);
    }
}
